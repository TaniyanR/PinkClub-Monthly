...
if (!defined('APP_NAME')) {
    define('APP_NAME', 'PinkClub Monthly');
}
if (!defined('BASE_URL')) {
...
return [
    'db' => $dbConfig,
    'security' => [
        'session_name' => 'pinkclub_monthly_session',
    ],
    'dmm' => [
        'endpoint' => 'https://api.dmm.com/affiliate/v3/',
        'site' => 'FANZA',
        'service' => 'monthly',
        'floor' => 'monthly_videoa',
        'master_floor_id' => '43',
        'catalog_targets' => [
            ['site' => 'FANZA', 'service' => 'monthly', 'floor' => 'monthly_videoa', 'label' => '見放題ch'],
            ['site' => 'FANZA', 'service' => 'monthly', 'floor' => 'monthly_videoc', 'label' => '見放題ch デラックス'],
            ['site' => 'FANZA', 'service' => 'monthly', 'floor' => 'monthly_vr', 'label' => 'VRch'],
        ],
    ],
    'pagination' => [
        'per_page' => 32,
